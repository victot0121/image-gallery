...
//                   <input type="text" className='appearance-none  bg-transparent border-none
//                    w-full text-gray-700 mr-3 py-2 px-2 leading-tight focus:outline-none '
//                     onChange={e=>setText(e.target.value)} placeholder='Search Image .........' />
